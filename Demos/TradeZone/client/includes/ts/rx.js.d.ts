...
declare module Rx {
    ...
    export module Internals {
        interface IScheduledObserver extends IAbstractObserver {
            ...
            isAcquired: bool;
            hasFaulted: bool;
            queue: { (valueOrException: any): void; (): void; }[];
    ...
    interface IObservable {
        ...
        buffer(timespan: number): IObservable;
        bufferWithTime(timespan: number): IObservable;
        ...
        sample(count: number): IObservable;
